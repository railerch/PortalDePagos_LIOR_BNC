window.onload = () => {
    console.log("Install script Ready!");

    // ACTIVAR EL SERVICE WORKER DE LA APP
    // Validar que no este un SW cargado previamente
    if ("serviceWorker" in navigator) {
        navigator.serviceWorker.register("/portalpagos_dev/service-worker.js")
    ...
    let installLnk = document.getElementById("install-app-btn");
